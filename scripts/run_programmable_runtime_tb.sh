...
build_dir="${TMPDIR:-/tmp}/cnn_programmable_runtime_tb"
rm -rf "$build_dir"

verilator --binary --timing \
  -Irtl/include \
  -Wno-fatal -Wno-WIDTHTRUNC -Wno-WIDTHEXPAND \
  --top-module tb_programmable_runtime_top \
  ...
  tb/tb_programmable_runtime_top.sv \
  -Mdir "$build_dir"

"$build_dir/Vtb_programmable_runtime_top"
